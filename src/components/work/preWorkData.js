import React from 'react'
  ...
  [
      ...
      {
          title:"Smarty Pantz",
          subtitle:"UI Design & Full-stack development win React with Spotify’s API, Cloud Firestore",
          img:"smartypantz.png",
          info:<div>Smarty Pantz is a game that tests your knowledge on music in different categories. The game is played on the web, and built with Spotify’s API, Cloud Firestore, React, HTML and CSS. The game was built as a part of the course <i>DH2642 Interaction Programming and the Dynamic Web</i> at KTH. Apart from the development, I also did the user interface design. Click the link below to play the game - and find out if you are the smartest of Smarty Pantz… or just a dumb sock : (</div>,
      ...
      {
          title:"The Card Game",
          subtitle: "Full-stack development in React, CSS, Cloud Firestore and UI design",
          img:"thecardgame.png",
...

      {
          ...
          info:<div>Find The Drink is a mobile-based web app that focuses on the user's GPS position and device orientation. The app finds the user’s position, and suggests a random beverage from the inventory of the closest Systembolag. If the user wants another suggestion they have to point their phone in a different cardinal direction, suggested by the app. The app was built with React Native, Google-Maps-React, Systembolaget’s API and the Baas Cloud Firestore. It was build as a part of the course <i>DM2518 Mobile Development with Web Technologies</i> at KTH</div>,
