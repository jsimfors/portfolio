...
[
    {
        ...
        infoLong:<div>In this project I, together with my team, decided to dive deep into Stockholm's top travel app - SL, with the goal to find new design solutions for the new problems that have occurred due to corona. The project was centered around the question 
        “How can technology be used to minimize physical interaction?”. Technical tools used was Miro, for the discover and define phase, and Figma and Marvel for the develop and deliver phase. User research was made firstly through surveys for quantitative 
        data collection, and later through in-depth-interviews for qualitative data. Different personas were also created to test the design. In the development phase, both hand-drawn low-fi sketches and later, digital high-fi sketches were used. In the delivery phase, both a prototype 
        (<a href="https://marvelapp.com/prototype/baf0iig/screen/73760598">check it out here!</a>) and a workbook was created:
        </div>,
        ...
        links: [
            {
                name: "Link to Project Workbook",
                url: "https://drive.google.com/file/d/1SPIyqti6yYOd1LYHU36_-LqrT4zPcVXS/view?usp=sharing"
            },
            {
                name: "Live Demo",
                url: "https://marvelapp.com/prototype/baf0iig/screen/73760598"
            },
        ],
    ...
    },
    {
        ...
        links: [
            {
                name: "Visit Studs Course Website",
                url: "https://www.kth.se/student/kurser/kurs/AI2151?l=en"
            },
        ],
        linktext: ""     
    },
    ...
    },
    {
        ...
        infoShort:"When DELL EMC released their new Canvas 27” drawing tablet in 2018, I was invited as an illustrator as they visited different exhibitions. My job consisted of inviting people into the exhibition stand and draw their caricature portrait as well as showing off the product.",
        infoLong:"When DELL EMC released their new Canvas 27” drawing tablet in 2018, I was invited as an illustrator as they visited different exhibitions. My job consisted of inviting people into the exhibition stand and draw their caricature portrait as well as showing off the product.",
        toolsUsed: ["Typescript", "React", "Angular", "CSS", "ESLint"],
        myResp: ["Job 1", "Job 2", "Job 3"],
        links: [],
        linktext: ""     
    },
    {
        ...
        infoShort:"Head of PR for Kollin.io spring of 2018, the work consisted of starting up an account and producing image and text content on instagram.",
        infoLong:"Head of PR for Kollin.io spring of 2018, the work consisted of starting up an account and producing image and text content on instagram.",
        toolsUsed: ["Typescript", "React", "Angular", "CSS", "ESLint"],
        myResp: ["Job 1", "Job 2", "Job 3"],
        link:"https://instagram.com/kollin.io",
        links: [
            {
                name: "Visit the Instagram",
                url: "https://instagram.com/kollin.io",
            },
        ],
        linktext: ""
    },
    ...
    },    
    {
        ...
        links: [
            {
                name: "Read My Comics",
                url: "https://instagram.com/simforsspaning",
            },
            {
                name: "Visit my Graphic Design based Instagram",
                url: "https://instagram.com/jsimfors",
            },
        ],
